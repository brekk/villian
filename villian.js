...
var callWithScopeWhen = curry$1(function (effect, when, what, value) {
  var scope = what(value);
  if (when(scope)) effect(scope);
  return value;
});
var callBinaryWithScopeWhen = curry$1(function (effect, when, what, tag, value) {
  var scope = what(value);
...
callWithScopeWhen($$1, $$1, I);
callWithScopeWhen($$1, always, I);
callWithScopeWhen($$1, always);
callBinaryWithScopeWhen($$1, $$1, I);
callBinaryWithScopeWhen($$1, always);
var callBinary = callBinaryWithScopeWhen($$1, always, I);
...
inspect(I);
callBinaryWithScopeWhen(console.log, $$1, I);
...
const addScope = curry((scope, x) => `${scope}:${x}`);

const testableMultiTrace = curry(
...
_curry1$1(function applySpec(spec) {
  ...
  return curryN$1(reduce$1(max, 0, pluck('length', values(spec))), function () {
    var args = arguments;
...
_curry2$1(
/*#__PURE__*/
_dispatchable$1(['fantasy-land/chain', 'chain'], _xchain, function chain(fn, monad) {
...
_dispatchable$1(['filter'], _xfilter, function (pred, filterable) {
  return _isObject(filterable) ? _reduce$1(function (acc, key) {
...
function _toString(x, seen) {
  ...
  switch (Object.prototype.toString.call(x)) {
    ...
    case '[object Array]':
      return '[' + _map$1(recur, x).concat(mapPairs(x, reject(function (k) {
        return /^\d+$/.test(k);
      }, keys$2(x)))).join(', ') + ']';
...
var some$1$1 = function fastSome (subject, fn, thisContext) {
  var length = subject.length,
...
var curry$3 = function (fn) {
  var test = function (x) { return x === PLACEHOLDER$1; };
  return function curried() {
    var arguments$1 = arguments;
    var argLength = arguments.length;
    var args = new Array(argLength);
...
function pipe$3() {
  ...
  return innerpipe$1(args)
}

var prop$2 = curry$3(function (property, o) { return o && property && o[property]; });
var _keys$1 = Object.keys;
var keys$3 = _keys$1;

var propLength$1 = prop$2("length");
pipe$3(keys$3, propLength$1);

var delegatee$1 = curry$3(function (method, arg, x) { return (x[method](arg)); });

delegatee$1("filter");

function curryObjectN$1(arity, fn) {
  return function λcurryObjectN(args) {
    var joined = function (z) { return λcurryObjectN(Object.assign({}, args, z)); };
    return (
      args && Object.keys(args).length >= arity ?
...
var e0 = curry$3(entrust0);

var callWithScopeWhen$1 = curry$3(function (effect, when, what, value) {
  var scope = what(value);
  if (when(scope)) effect(scope);
  return value;
});
var callBinaryWithScopeWhen$1 = curry$3(function (effect, when, what, tag, value) {
  var scope = what(value);
  if (when(tag, scope)) effect(tag, scope);
  return value;
});
...
callWithScopeWhen$1($$2, $$2, I$1);
callWithScopeWhen$1($$2, always$1, I$1);
callWithScopeWhen$1($$2, always$1);
callBinaryWithScopeWhen$1($$2, $$2, I$1);
callBinaryWithScopeWhen$1($$2, always$1);
callBinaryWithScopeWhen$1($$2, always$1, I$1);

var traceWithScopeWhen$1 = callBinaryWithScopeWhen$1(console.log);
var traceWithScope$1 = traceWithScopeWhen$1(always$1);
var inspect$1 = traceWithScope$1;
inspect$1(I$1);
callBinaryWithScopeWhen$1(console.log, $$2, I$1);

var segment$1 = curryObjectN$1(3, function (_ref) {
  var _ref$what = _ref.what,
...
var array = createCommonjsModule$1(function (module, exports) {
...
var errno = createCommonjsModule$1(function (module, exports) {
Object.defineProperty(exports, "__esModule", { value: true });
...
var fs = createCommonjsModule$1(function (module, exports) {
Object.defineProperty(exports, "__esModule", { value: true });
...
var path_1 = createCommonjsModule$1(function (module, exports) {
Object.defineProperty(exports, "__esModule", { value: true });
...
var pattern = createCommonjsModule$1(function (module, exports) {
Object.defineProperty(exports, "__esModule", { value: true });
...
function merge2 () {
  const streamsQueue = [];
  const args = slice$2.call(arguments);
  let merging = false;
...
var tasks = createCommonjsModule$1(function (module, exports) {
Object.defineProperty(exports, "__esModule", { value: true });
...
var async = createCommonjsModule$1(function (module, exports) {
Object.defineProperty(exports, "__esModule", { value: true });
exports.read = void 0;
...
var sync = createCommonjsModule$1(function (module, exports) {
Object.defineProperty(exports, "__esModule", { value: true });
exports.read = void 0;
...
var settings = /*#__PURE__*/Object.defineProperty({
	default: _default
}, '__esModule', {value: true});

var out = createCommonjsModule$1(function (module, exports) {
Object.defineProperty(exports, "__esModule", { value: true });
...
var fs$1 = createCommonjsModule$1(function (module, exports) {
Object.defineProperty(exports, "__esModule", { value: true });
exports.createDirentFromStats = void 0;
class DirentFromStats {
    constructor(name, stats) {
...
var common$1 = createCommonjsModule$1(function (module, exports) {
Object.defineProperty(exports, "__esModule", { value: true });
...
var sync$1 = createCommonjsModule$1(function (module, exports) {
Object.defineProperty(exports, "__esModule", { value: true });
exports.readdir = exports.readdirWithFileTypes = exports.read = void 0;
...
var fs_1$1 = createCommonjsModule$1(function (module, exports) {
Object.defineProperty(exports, "__esModule", { value: true });
exports.createFileSystemAdapter = exports.FILE_SYSTEM_ADAPTER = void 0;
...
var _default$1 = Settings$1;

var settings$1 = /*#__PURE__*/Object.defineProperty({
	default: _default$1
}, '__esModule', {value: true});

var out$1 = createCommonjsModule$1(function (module, exports) {
Object.defineProperty(exports, "__esModule", { value: true });
...
var _default$8 = Settings$2;

var settings$2 = /*#__PURE__*/Object.defineProperty({
	default: _default$8
}, '__esModule', {value: true});

var out$2 = createCommonjsModule$1(function (module, exports) {
Object.defineProperty(exports, "__esModule", { value: true });
...
var _default$g = EntryTransformer;
...
var _default$l = ProviderSync;

var sync$5 = /*#__PURE__*/Object.defineProperty({
	default: _default$l
}, '__esModule', {value: true});

var settings$3 = createCommonjsModule$1(function (module, exports) {
Object.defineProperty(exports, "__esModule", { value: true });
...
encaseP(CANCEL, out$3);
encaseP(CANCEL, getStdin);
const readFile = z =>
...
pipe$2(map$1(keys$2), reduce$1(concat, []), sort);
curry$2(
...
curry$2((x, y) => !includes(x, y));

curryN$1(2, path__default['default'].resolve);
...
var getArgs$1 = function getArgs() {
  var args = arguments.length > 0 && arguments[0] !== undefined ? arguments[0] : process.argv.slice(2);
  return yargsParser(args, CLI_CONFIG);
};
var indexedArray = curry$2(function (y, x) {
  return [x, y];
});

var _map$2 = map$1(indexedArray, keys$2(RELATIONSHIP_FIELDS)),
    _map2 = _slicedToArray(_map$2, 3),
    mArr = _map2[0],
    nArr = _map2[1],
    cArr = _map2[2];

var convertDataToErrors = reduce$1(function (a, _ref) {
  var _ref2 = _slicedToArray(_ref, 2),
      def = _ref2[0],
      expected = _ref2[1];

  var c = pipe$2(reject(function (_ref3) {
    var _ref4 = _slicedToArray(_ref3, 1),
        name = _ref4[0];

    return GLOBAL_EXCLUDES.includes(name);
  }), map$1(function (_ref5) {
    var _ref6 = _slicedToArray(_ref5, 2),
        name = _ref6[0],
        cause = _ref6[1];

    return "Unexpected reference in ".concat(def, " (").concat(cause, "=").concat(name, ")");
  }))(expected);
  return a.concat(c);
}, []);
var concatenateCauses = function concatenateCauses(_ref7) {
  var _ref8 = _slicedToArray(_ref7, 2),
      k = _ref8[0],
      _ref8$ = _ref8[1],
      contains = _ref8$.contains,
      nextgroup = _ref8$.nextgroup,
      matchgroup = _ref8$.matchgroup;

  return [k, pipe$2(map$1(cArr), concat(map$1(nArr, nextgroup)), concat(map$1(mArr, matchgroup)))(contains)];
};
var filterRelativeToStdIn = curry$2(function (getFlags, zzz) {
  var input = prop$1('validate')(getFlags());
  return input ? filter(function (_ref9) {
...
var validateSyntax = curry$2(function (getFlags, zzz) {
  return pipe$2(JSON.parse, prop$1('syntaxes'), filter(propEq('valid', false)), map$1(pipe$2(of, ap([prop$1('name'), prop$1('expected')]), concatenateCauses)), filterRelativeToStdIn(getFlags), convertDataToErrors)(zzz);
});
var swapToRejectionBranch = chain$1(function (raw) {
  return ifElse$1(pipe$2(length, equals(0)), function () {
    return resolve($.green('Hooray, no errors!'));
  }, reject$1)(raw);
});
var validate = pipe$2(map$1(validateSyntax(getArgs$1)), swapToRejectionBranch);
var log = complextrace('villian', ['structure', 'structureDetail', 'relationships', 'relationshipsDetail', 'names', 'namesDetail', 'validation', 'validationDetail']);
var structureData = pipe$2(log.structure('input'), map$1(function (datapoint) {
  var _datapoint$split = datapoint.split('='),
      _datapoint$split2 = _slicedToArray(_datapoint$split, 2),
      k = _datapoint$split2[0],
      v = _datapoint$split2[1];
  ...
  return _defineProperty({}, k, typeof v === 'string' && ~v.indexOf(',') ? v.split(',') : !v ? true : v);
}), log.structureDetail('mapped'), reduce$1(mergeRight$1, {}), log.structure('output'));
var swapNull = function swapNull(x) {
  return x && typeof x === 'string' ? [x] : x[0] === '' ? [] : x;
};
var getRelationalData = pipe$2(log.relationships('input'), applySpec({
...
}), log.relationshipsDetail('applied spec'), map$1(pipe$2(swapNull)), log.relationships('output'));
var stripAtSign = function stripAtSign(z) {
  return z[0] === '@' ? z.substr(1) : z;
};
var skipSomeGlobals = curry$2(function (expected, z) {
  return reject(function (zz) {
    return expected.includes(zz);
  }, z);
});
var skipGlobals = skipSomeGlobals(GLOBAL_EXCLUDES);
var getAllNames = pipe$2(log.names('input'), map$1(pipe$2(of, ap([prop$1('name'), path(['data', RELATIONSHIP_FIELDS.matchgroup])]))), log.namesDetail('transformed'), reduce$1(concat, []), filter(identity), uniq, log.names('output'));
var invalidRelativeToNames = curry$2(function (names, match) {
  return ifElse$1(pipe$2(length, lt(0)), pipe$2(skipGlobals, map$1(stripAtSign), without(names)), function () {
    return [];
  })(match);
});
var cumulativeLength = pipe$2(toPairs, reduce$1(function (w, _ref12) {
  var _ref13 = _slicedToArray(_ref12, 2),
      v = _ref13[1];

  return w + v.length;
}, 0));
var solveValidity = curry$2(function (names, agg, x) {
  ...
  var _getRelationalData = getRelationalData(x),
      contains = _getRelationalData.contains,
      nextgroup = _getRelationalData.nextgroup,
      matchgroup = _getRelationalData.matchgroup;

  var invalid = invalidRelativeToNames(names);
  var matched = map$1(invalid, {
    contains: contains,
    nextgroup: nextgroup,
    matchgroup: matchgroup
  });
  var expected = map$1(filter(identity), matched);
  log.validationDetail('matched', expected);
  var valid = cumulativeLength(expected) === 0;

  var y = _objectSpread2(_objectSpread2({}, x), {}, {
    valid: valid
  });

  log.validation('output singular', y);
  return valid ? agg.concat(y) : agg.concat(_objectSpread2(_objectSpread2({}, y), {}, {
    expected: expected
  }));
});
var unsliceLine = pipe$2(trim, split(characters.n), map$1(pipe$2(trim, replace(/^\\/, ''), trim)), join(characters._), trim);
var unfoldLeadingSlashes = reduce$1(function (list, b) {
  if (!b.trim().startsWith('\\')) {
    return list.concat(b);
  }

  var cleaned = unsliceLine(b);
  var prev = last(list); // const priorMatch =
  // prev && list.length > 2 && prev.startsWith('syntax')

  return init$1(list).concat(prev + ' ' + cleaned);
}, []);
var matchMatchKeywordOrRegionOnly = pipe$2(split(characters._), map$1(trim), nth(1), function (raw) {
  return ['match', 'keyword', 'region'].includes(raw);
});
var structurizeArrays = map$1(function (_ref14) {
...
var readSyntax = pipe$2(readFile, map$1(pipe$2(split(characters.n), unfoldLeadingSlashes, filter(startsWith('syntax')), filter(matchMatchKeywordOrRegionOnly), map$1(pipe$2(split(characters._), filter(identity), map$1(trim))), structurizeArrays, function (all) {
  var names = getAllNames(all);
  return {
    entities: names,
    syntaxes: reduce$1(solveValidity(names), all, all)
  };
}, j2)));
/* istanbul ignore next */

var handleErrorCase = fork(function (err) {
  console.error($.red("Found ".concat(err.length, " invalid relationships:")));
  console.error(err);
  process.exit(1);
})(function (raw) {
  console.log(raw);
...
var handleSuccessCase = fork(console.error)(console.log);
var villianWithOptions = curry$2(function (bad, good, _ref16) {
  var raw = _ref16._,
      doValidate = _ref16.validate,
      help = _ref16.help;
  return pipe$2(ifElse$1(function () {
    return help;
  }, function () {
    return console.log(HELPTEXT);
  }, pipe$2(head, readSyntax, ifElse$1(function () {
    return is(String, doValidate);
  }, pipe$2(validate, bad), good))))(raw);
});
var villian = villianWithOptions(handleErrorCase, handleSuccessCase);
